...
def create_question(question_text, days):
    """
    Create a question with a the given 'question_text' and published the given number of 'days' offset
    to now (negative for questions published in the past, positive for questions that have yet been published).
    """
